...
Then we make 4 groups for the variables. The groups are the following: low, med_low, med_high and high.
#G1 
...
The last thing to do is 3d modeling to make the results easier to read. As I only have two variables I left the Z = 0. This might affect the 3d plot making it appear a little bit biased.
