...
I am using the STUDENT ALCOHOL CONSUMPTION Data Set from "https://archive.ics.uci.edu/ml/datasets/STUDENT+ALCOHOL+CONSUMPTION". Here are the variables that I chose and also an explanation how to measure the variable.
...
alc_use | alcohol consumption (numeric: from 1 - very low to 5 - very high) 
